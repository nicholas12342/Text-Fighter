...
public class Stats {
    ...
    public static void view() {
        ...
        Ui.println("	In bank - " + Bank.get());
        Ui.println("	Won in Casino - " + Casino.totalCoinsWon);
        Ui.println("   Total Games Played in Casino - " + Casino.gamesPlayed);
        Ui.println("   Total coins spent - " + totalCoinsSpent);
        Ui.println("   Spent on bank interest - " + coinsSpentOnBankInterest);
        Ui.println("   Spent on weapons - " + coinsSpentOnWeapons);
        Ui.println("   Spent on health - " + coinsSpentOnHealth);
